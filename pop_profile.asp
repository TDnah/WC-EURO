		...
		if rs.BOF or rs.EOF then
			...
			if strUseExtendedProfile then
				Response.Write	"      <table width=""100%"" border=""0"">" & vbNewLine & _
						"        <tr>" & vbNewLine & _
						"          <td><font face=""" & strDefaultFontFace & """ size=""" & strDefaultFontSize & """>" & vbNewLine & _
						"          " & getCurrentIcon(strIconFolderOpen,"","") & "&nbsp;<a href=""default.asp"">Di&#7877;n &#273;&agrave;n</a><br />" & vbNewLine & _
						"          &nbsp;Th&ocirc;ng tin v&#7873;" & getCurrentIcon(strIconBar,"","") & getCurrentIcon(strIconFolderOpenTopic,"","") & "&nbsp;" & chkString(rs("M_NAME"),"display") & "'s Profile</font></td>" & vbNewLine & _
						"        </tr>" & vbNewLine & _
						"      </table>" & vbNewLine
			end if
			Response.Write	"      <table border=""0"" width=""100%"" cellspacing=""0"" cellpadding=""0"">" & vbNewLine & _
					...
					"          <font face=""" & strDefaultFontFace & """ size=""" & strHeaderFontSize & """>Th&ocirc;ng tin th&agrave;nh vi&ecirc;n<br /></font></td>" & vbNewLine & _
					"        </tr>" & vbNewLine & _
					"        <tr>" & vbNewLine & _
					"          <td bgColor=""" & strPageBGColor & """ align=""center""" & strColspan & ">" & vbNewLine & _
			...
			Response.Write	"                <td bgColor=""" & strPageBGColor & """ valign=""top"">" & vbNewLine & _
					...
					"                    </tr>" & vbNewLine & _
					"                    <tr>" & vbNewLine & _
					"                      <td bgColor=""" & strPopUpTableColor & """ align=""right"" nowrap width=""10%"" valign=""top""><b><font face=""" & strDefaultFontFace & """ size=""" & strDefaultFontSize & """>Nick name:&nbsp;</font></b></td>" & vbNewLine & _
			...
			if strFullName = "1" and (Trim(rs("M_FIRSTNAME")) <> "" or Trim(rs("M_LASTNAME")) <> "" ) then
				Response.Write	"                    <tr>" & vbNewLine & _
						"                      <td bgColor=""" & strPopUpTableColor & """ align=""right"" nowrap valign=""top""><b><font face=""" & strDefaultFontFace & """ size=""" & strDefaultFontSize & """>H&#7885; v&agrave; t&ecirc;n:&nbsp;</font></b></td>" & vbNewLine & _
						"                      <td bgColor=""" & strPopUpTableColor & """><font face=""" & strDefaultFontFace & """ size=""" & strDefaultFontSize & """>" & ChkString(rs("M_LASTNAME"), "display") & "&nbsp;" & ChkString(rs("M_FIRSTNAME"), "display") & "</font></td>" & vbNewLine & _
						"                    </tr>" & vbNewLine
			end if
			if (strCity = "1" and Trim(rs("M_CITY")) <> "") or (strCountry = "1" and Trim(rs("M_COUNTRY")) <> "") or (strState = "1" and Trim(rs("M_STATE")) <> "") then
				Response.Write	"                    <tr>" & vbNewLine & _
						"                      <td bgColor=""" & strPopUpTableColor & """ align=""right"" nowrap valign=""top""><b><font face=""" & strDefaultFontFace & """ size=""" & strDefaultFontSize & """>Số điện thoại:&nbsp;</font></b></td>" & vbNewLine & _
