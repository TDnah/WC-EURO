...
Sub DisplayProfileForm
	...
	if strCountry = "1" then
		Response.Write	"                    <tr>" & vbNewLine & _
				"                      <td bgColor=""" & strPopUpTableColor & """ align=""right"" valign=""middle"" nowrap><b><font face=""" & strDefaultFontFace & """ size=""" & strDefaultFontSize & """>Tel:&nbsp;</font></b></td>" & vbNewLine & _
				"                      <td bgColor=""" & strPopUpTableColor & """><font face=""" & strDefaultFontFace & """ size=""" & strDefaultFontSize & """>" & vbNewLine & _
				"                      <input name=""Country"" size=""25"" maxLength=""50"" value=""" & vbNewLine
		if strMode <> "Register" then
			Response.Write("" & rs("M_COUNTRY") & """>" & vbNewLine)
		else
			Response.Write	""""">" & vbNewLine
		end if
