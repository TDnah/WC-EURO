...
If strMode = "search"  and (srchUName = "1" or srchFName = "1" or srchLName = "1" or srchInitial = "1" ) then 
	...
	strSql = strSql & "M_AIM, M_ICQ, M_MSN, M_YAHOO, M_TITLE, M_POSTS, M_LASTPOSTDATE, M_LASTHEREDATE, M_DATE, M_FIRSTNAME, M_LASTNAME  "
...
if strCountry = "1" then
	...
	Response.Write	"""" & dWStatus("Sort by Country") & "><b><font face=""" & strDefaultFontFace & """ size=""" & strDefaultFontSize & """ color=""" & strHeadFontColor & """>Tel</font></b></a></td>" & vbNewLine
end if
...
if iMemberCount = "" then '## No Members Found in DB
	...
	for iMember = 0 to iMemberCount
		...
		Response.Write	ChkString(Members_MemberName,"display") & "</a> - " & Members_MemberLastName & " " & Members_MemberFirstName & "</span></font></td>" & vbNewLine & _
